...
export function MonthlyUsageChart({ data, title = 'Monthly Energy Usage', description }: MonthlyUsageChartProps) {
  // Group data by month
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={monthlyData}>
            ...
            <Tooltip />
            <Legend />
            <Bar yAxisId="left" dataKey="kwh" fill="#8884d8" name="Usage (kWh)" />
